	...
	: ee0::WxEditPanel(parent) 
{
	...
	m_sub_mgr.RegisterObserver(ee0::MSG_SELECTED_ONE_NODE, this);
}
...
void WxStagePage::NodeSelectionSetOne(const ee0::VariantSet& variants)
{
	m_node_selection.Clear();
