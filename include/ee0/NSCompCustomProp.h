...
public:
	...
	virtual void   LoadFromBin(const ur2::Device& dev,
	...
	virtual void LoadFromJson(const ur2::Device& dev,
        mm::LinearAllocator& alloc, const std::string& dir, const rapidjson::Value& val) override;

	//
	// memory
	//
	void StoreToMem(const ur2::Device& dev, ee0::CompCustomProp& comp) const;
